...
private String filename;
	...
	public AdministratorRepository() {
		this.filename = "administrators.json";
		this.initFile();
	}
	...
	private void saveAll(Collection<User> users)
	{
		...
		{
//			e.printStackTrace();
			System.out.println("There was an error trying to save to file administrators.json!");
		}
	}
...
//			e.printStackTrace();
			System.out.println("There was an error trying to read from file administrators.json!");
		}
		if(users == null) {
